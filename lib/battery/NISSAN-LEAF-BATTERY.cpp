    ...
    case 0x7BB:
      ...
      if (group_7bb == 1)  //High precision SOC, Current, voltages etc.
      {
        if (rx_frame.data[0] == 0x10) {  //First frame
          Battery_current_1 = (rx_frame.data[4] << 24) |
                              (rx_frame.data[5] << 16 | ((rx_frame.data[6] << 8) | rx_frame.data[7]));
        ...
        if (rx_frame.data[0] == 0x21) {  //Second frame
          Battery_current_2 = (rx_frame.data[3] << 24) |
                              (rx_frame.data[4] << 16 | ((rx_frame.data[5] << 8) | rx_frame.data[6]));
