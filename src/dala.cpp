...
#include "../lib/inverter/INVERTERS.h"
...
#ifdef WEBSERVER
#include "../Software/src/devboard/webserver/webserver.h"
#endif
...
//  CAN_cfg.rx_pin_id = GPIO_NUM_4;
  ...
  //ESP32Can.rx_queue = xQueueCreate(rx_queue_size, sizeof(twai_message_t));
  // Init CAN Module
//  ESP32Can.CANInit();
...
//  if (xQueueReceive(ESP32Can.rx_queue, &rx_frame, 3 * portTICK_PERIOD_MS) == pdTRUE) {
